...
export default class StudentNotification extends Component {
    ...
    retrieveReadNotifications = (username) => {
        axios.get("/api/v1/notification/retrieveRead/student/" + username, {headers: authHeader()})
            .then(response => {
    ...
    retrieveUnreadNotifications = (username) => {
        axios.get("/api/v1/notification/retrieveUnread/student/" + username, {headers: authHeader()})
            .then(response => {
                let responseObject = response.data;
                console.log(responseObject);
                this.setState({
    ...
    markAsRead = (username, notificationIdList) => {
        axios.post("/api/v1/notification/read/student/" + username, notificationIdList,{headers: authHeader()})
            .then(response => {
                let responseObject = response.data;
                console.log(responseObject);
            })
